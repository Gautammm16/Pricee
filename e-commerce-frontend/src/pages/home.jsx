 ...
 const [searchSuggestion,setSearchSuggestion]= useState(null)
  const getkeyword = async()=>{
    if(searchparam.length>3){
      ...
      const fetchkeyword = await fetch(`${window.path}/searchproductkeywords/${searchparam}`,{
        method:"get"
      })
        ...
        <div className="container">
          ...
          <div className="flex justify-center w-full mt-5">
            <div className="w-[30rem]">
              ...
              {
                  showSearchKeys==true && searchparam.length>=3 && searchSuggestion != null ? 
                ...
                <ul className=" py-1 text-sm text-gray-900  border-gray-300  bg-white  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ">
                  {
                    searchSuggestion.map((e)=>(
                      ...
                      <Link to={`/searchproduct/${e}`} className="cursor-pointer hover:underline pl-10 py-1" 
                        >{e}</Link>
                        </li>
                    ))
                  }
              ...
              <div className="px-5 flex justify-center mt-2">
                <h1 className="text-center text-red-500">
                  ...
                  popularSearches.map((e)=>(
                    <span  className="cursor-pointer hover:underline" onClick={()=>{navigate(`/searchproduct/${e.name}`)}}>
                    {`${e.name},`}
                    </span>
                    ))
                  }
          ...
          <div className="mt-10">
            ...
            <Carousel className="" responsive={responsive} >
              {
               product.map((e) => (
                <div className="max-w-sm bg-white border border-gray-200 rounded-2xl shadow dark:bg-gray-800 dark:border-gray-700 mr-6 ml-12 ">
                  ...
                  <div className="w-full rounded-b-xl bg-zinc-200 flex justify-between px-3  items-center">
                    ...
                    <button className="bg-red-600 rounded-xl px-5 py-2 text-sm text-white" onClick={()=>{window.open(e.url, '_blank', 'noreferrer');}}>
                      BUY
                    </button>
                  </div>
                </div>
    ...
    <div className="bg-white pt-24 -pb-1rem sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 grid max-w-lg grid-cols-1 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-4 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-4 tab:max-w-none tab:grid-cols-3  border rounded-lg p-9">
            {
               popularCategory != null && popularCategory["Popular Categories"].map((e)=>(

                 
                 <>
              
                       
          <div className="grid cursor-pointer" onClick={()=>navigate(`${e.url.slice(19)}`)}>
